...
<html:link action="/camps/text_attributes_no_check?method=attributes_form&no_action=true">
<bean:message key="label.text.attribute.back"/>
</html:link>
<br><br>
...
%>
<html:form action="/camps/modify_text_attribute">
